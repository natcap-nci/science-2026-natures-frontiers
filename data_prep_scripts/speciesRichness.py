...
threatened_list	 =   '/home/groups/gdaily/global2/IUCN/assessments.csv'
redList         =   pd.read_csv(threatened_list, encoding = 'latin-1', usecols = ['scientificName', 'redlistCategory'])
...
for country in countryList:	
	...
	speciesRichness(amphibian_files, 'Amphibians')
	speciesRichness(bird_files, 'Birds')
	speciesRichness(mammal_files, 'Mammals')
	speciesRichness(reptile_files, 'Reptiles')
