...
ANNUAL_BIOMASS_CLASS_RASTER_PATH = os.path.join(
    WORKSPACE_DIR, 'derived_data', 'class_ann_biomass_proj.tif')
...
def main():
    ...
    try:
        ...
        ann_bio_class_task = task_graph.add_task(
            func=create_class_raster,
            args=(
                ANNUAL_BIOMASS_RASTER_PATH,
                ANNUAL_BIOMASS_CLASS_RASTER_PATH),
            target_path_list=[ANNUAL_BIOMASS_CLASS_RASTER_PATH],
            task_name='create class raster for ann_bio')
        ann_bio_class_task.join()
        ...
        for (scenario_id, value_raster_path, class_raster_path,
             scale_raster_path, valid_lulc_code_list) in [
                ('annual_biomass', ANNUAL_BIOMASS_RASTER_PATH,
                 ANNUAL_BIOMASS_CLASS_RASTER_PATH, NPP_RASTER_PATH,
                 FORESTRY_VALID_LULC_LIST,),
